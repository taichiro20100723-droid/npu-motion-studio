...
$Output = Join-Path ([Environment]::GetFolderPath('UserProfile')) 'Downloads\WasedaSaga-Festival-MV-safe.mp4'
...
& $Python (Join-Path $ProjectRoot 'scripts\make_music_video.py') $Source `
    ...
    --mode fun --anchors 8 --backgrounds $Backgrounds --photo-every 4 --output $Output
