...
> **5秒で見るデモ：** 巨大ロボットが、本物の柴犬へ変身します。最初の画像と最後の画像は自分で決め、
> その「ありえない途中」だけをIntelノートPCの中で生成します。
...
「最初と最後がわかる」「途中が意外」「短いMP4で見せやすい」ことを重視しています。MV、ショート動画、
作品の発表、製品コンセプト、ミーム、映像実験に向いています。
