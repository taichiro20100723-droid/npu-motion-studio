...
- 最初はNPU画像4枚だけで確認し、気に入った時だけ8〜24枚へ高品質化できます。
...
5. 「まず4枚で動きを確認」を押します。気に入らなければここで止められます。
6. 良ければ「これでOK・高品質化」を押します。通常はおすすめの12枚で大丈夫です。
7. もっと細かくしたい時だけ、詳細設定で8・12・16・20・24枚から選びます。
...
| v0.5 ロボット→犬、4枚プレビュー、4秒 | **2.83秒**（高速補間版） |
| v0.5 同じ入力を12枚へ高品質化、4秒 | **18.05秒** |
